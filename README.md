...
# Documentation
The original developer has written a 
[blog post describing all the features of the wedding website I used as a reference](https://blog.rampatra.com/wedding-website) and how to customize it according to your needs.

# Special Thanks
Forked repo from `https://github.com/rampatra/wedding-website.git` as a starting point which saved me a LOT of headaches, so thank you for the runway!
